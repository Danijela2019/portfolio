    ...
    return (
        <section className="timeline_item">
            <article className="timeline_item_content">
                ...
                {!data.video ? <img className="timeline_item_img" src={data.img} alt="Project screen"></img> :
                <video className="timeline_item_img"  src={data.img} muted onMouseOver={event => event.target.play()}/>
                }
